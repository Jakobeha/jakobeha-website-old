  ...
  return (
    <div className="App" style={{ backgroundImage: `url(${Background})` }}>
      ...
      <div className="App-content">
        <Section title="Projects" style={SectionStyle.Row}>
          <Entry
            title="RIR"
        ...
        <Section title="About" style={SectionStyle.Row}>
          ...
          <Entry title="Experience" resume={ResumeLink}>
      ...
      <a
        className="App-bg-credit"
        href="https://www.pexels.com/photo/branches-daylight-environment-forest-230978/"
      >
        <i>Background by Terje Solle</i>
      </a>
    </div>
  );
}
